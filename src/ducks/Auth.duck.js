...
export const signup = params => (dispatch, getState, sdk) => {
  ...
  const { email, password, firstName, lastName, clientType, ...rest } = params;

  const isProvider = clientType === 'provider';
  console.log(isProvider)
  const createUserParams = isEmpty(rest)
    ? { email, password, firstName, lastName, publicData:{isProvider} }
    : { email, password, firstName, lastName, publicData:{isProvider}, protectedData: { ...rest } };
